class AdminPage {
    ...
    init() {
        this.authManager.auth.onAuthStateChanged(user => {
            if (user && this.authManager.user?.role === 'Администратор') {
